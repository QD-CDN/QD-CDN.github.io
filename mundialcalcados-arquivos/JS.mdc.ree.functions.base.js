...
try {
	...
	var Search = {
		...
		callSliderFilterPlice: function() {
			...
			var filterPrice = $('.search-qd-v1-navigator input[rel*="fq=P:"]:first-child');
			var filterTitle = $('<span class="search-filters-qd-v1-title">De 200€  a  600€</span>');
			...
			filterPriceSlide.insertAfter(filterPrice.parent()).slider({
				...
				slide: function(event, ui) {
					filterTitle.text('De ' + ui.values[0] + '€  a  ' + ui.values[1] + '€');
				},
			...
			filterPriceSlide.before(filterTitle);
		},
		
		callPerfectScrollbar: function() {
			var wrapper = $('.search-qd-v1-navigator');

			wrapper.find('fieldset').each(function() {
				var $t = $(this);
				var $label = $t.find('label');

				$label.parent().addClass('qd-v1-perfect-scrollbar');

				if ($t.find('label').length >= 6)
					$t.find('.qd-v1-perfect-scrollbar').css('max-height', '167px').perfectScrollbar({
...
// qd-include ../qd-smart-research/QD-smartResearch.min.js
// qd-include ../QD-Infinity-Scroll/QD_infinityScroll.min.js
