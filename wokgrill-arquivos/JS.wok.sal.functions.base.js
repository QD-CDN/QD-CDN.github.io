...
try {
	...
	var Home = {
		...
		initScrollMagic: function() {
			var element = $(".home-qd-v1-animation-air-relative div:nth-child(1) > img");
			var controller = new ScrollMagic.Controller();
			var trigger = "#scrollmagic-two";
			var tweenDuration = 2000;

			new ScrollMagic.Scene( { triggerElement: trigger})	
				.setTween(TweenMax.to(element, 6, {rotation:360, repeat:-1, ease: Linear.easeNone, transformOrigin:"50% 50%" }))
				.addTo(controller);
		},
